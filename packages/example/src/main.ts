...
const h =
    (tag: string, attrs: Record<string, unknown>, children: StaticComponent[]): StaticComponent =>
        ({ tag, attrs, children });
...
*/
type ComponentWithEffect<Props> = (props: Props) => Promise<[StaticComponent, ScriptPath[]]>;

const html: StaticComponent =
    h("html", {}, [
        h("head", {}, [
